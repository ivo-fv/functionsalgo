...
public class RunSampleStratBacktest {
    ...
    public static void main(String[] args) throws ExchangeException {
        ...
        // timeRangeStart.add(LocalDateTime.of(2020, 2, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeStart.add(LocalDateTime.of(2020, 3, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeStart.add(LocalDateTime.of(2020, 4, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeStart.add(LocalDateTime.of(2020, 5, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeStart.add(LocalDateTime.of(2020, 6, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        ArrayList<Long> timeRangeEnd = new ArrayList<Long>();
        // timeRangeEnd.add(LocalDateTime.of(2020, 1, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        timeRangeEnd.add(LocalDateTime.of(2020, 2, 1, 0, 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeEnd.add(LocalDateTime.of(2020, 3, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeEnd.add(LocalDateTime.of(2020, 4, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeEnd.add(LocalDateTime.of(2020, 5, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeEnd.add(LocalDateTime.of(2020, 6, 1, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        // timeRangeEnd.add(LocalDateTime.of(2020, 6, 23, 0,
        // 0).toInstant(ZoneOffset.UTC).toEpochMilli());
        ...
        System.out.println(
                "Backtest with the highest margin balance: #" + highestMBBacktest + " with " + highestMarginBalance);
