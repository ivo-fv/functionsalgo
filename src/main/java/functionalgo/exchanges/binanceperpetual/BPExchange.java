...
public interface BPExchange extends Exchange {
    ...
    void batchMarketOpen(String orderId, String symbol, boolean isLong, double symbolQty);
    
    void batchMarketClose(String orderId, String symbol, boolean isLong, double qtyToClose);
     ...
     * The BPAccount instance returned by executeBatchedOrders will contain the state of the account's
     ...
     */
    BPAccount executeBatchedOrders();
}
